...
out = "var emblemdata = {\n"
out += "\ttype: "
out += str(["Letter " + x for x in list(string.ascii_uppercase)] + ["Zero", "One", "Two", "Three", "Four", "Five", "Six", "Seven", "Eight", "Nine"])
out += ",\n\ttools: "  
    
out += str(["Half Circle", "Quarter Circle", "Half Heart", "Cone", "Thimble", "Kiss", "Scribble", "Round Square", "Ninja Star", "Half Star", "Shuriken", "Half Shuriken", "Lamp Shade",
